    ...
    >
      ...
      {isLoanedBook && (
        <div className="mt-3 w-full">
          <div className="flex flex-row items-center gap-1 max-små:justify-center">
            <Image
            ...
            />
            <p className="text-gray-600">11 days left to return</p>
          </div>
          <Button className="bg-gray-600 mt-3 min-h-14 w-full font-bebas-neue text-base text-white">
            Download Receipt
          </Button>
        </div>
      )}
